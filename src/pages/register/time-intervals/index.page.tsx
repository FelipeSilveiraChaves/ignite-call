...
const timeIntervalsFormSchema = z.object({
  intervals: z
    ...
    .refine(
      ...
      {
        message:
          'O horário de término deve ser pelo menos 1h a mais que o de início',
      },
    ),
})
  ...
  return (
    <Container>
      <Header>
        ...
        <Text>
          CDefina o intervalo de horários que você está disponível em cada dia
          da semana.
        </Text>

        <MultiStep size={4} currentStep={3} />
      </Header>
      {/* @ts-expect-error Bug no output e input */}
                ...
                <Controller
                  ...
                  render={({ field }) => {
                    return (
                      <Checkbox
                        onCheckedChange={(
                          checked: true | false | 'inderteminate',
                        ) => {

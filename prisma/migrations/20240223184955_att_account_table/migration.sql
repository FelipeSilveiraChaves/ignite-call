...
INSERT INTO "new_accounts" ("accessToken", "accessTokenExpires", "id", "providerAccountId", "refreshToken", "userId") SELECT "accessToken", "accessTokenExpires", "id", "providerAccountId", "refreshToken", "userId" FROM "accounts";
DROP TABLE "accounts";
